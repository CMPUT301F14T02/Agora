...
public class SertServerMappingsTestES extends ActivityInstrumentationTestCase2<MainActivity> {

	public SertServerMappingsTestES() {
	...
	protected void setUp() throws Exception {
		...
		try {
			HttpDelete deleteRequest = new HttpDelete("http://cmput301.softwareprocess.es:8080/cmput301f14t02/mapping");
	...
	private class TestESManager extends ESDataManager {
		public TestESManager() {
			super("http://cmput301.softwareprocess.es:8080/", "cmput301f14t02/", "mapping/");
		}
	}
...
//		// set the mapping
//		es.setServerMapping();
		// get the mapping and ensure its as expected
//		HttpClient getClient = new DefaultHttpClient();
//		HttpGet getRequest = new HttpGet("http://cmput301.softwareprocess.es:8080/cmput301f14t02/mapping");

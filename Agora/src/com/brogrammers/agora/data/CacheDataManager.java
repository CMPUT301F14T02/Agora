...
//	protected List<QuestionPreview> questionPreviewList; // for getQuestions()
	 ...
	 * object to file 
	 * 
	 * @param q the question object we are adding to the cache
	 */
	 ...
	 * 
	 * @param a 	the answer object we are adding to the cache
	 * @param qID 		the unique question id where the answer is added to
	 */
	 ...
	 * 
	 * @param c 	the comment object we are adding to the cache
	 * @param qID 		the unique question id if we are commenting on the question, or null if commenting answer
	 * @param aID 		the unique answer id if we are commenting the answer, or null if commenting question
	 */
